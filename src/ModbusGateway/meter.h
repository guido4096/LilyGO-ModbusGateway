...
namespace modbus
{
    ...
    public:
        RegisterBlock() {}
        RegisterBlock(const char *name) : _name(name) {}
        ~RegisterBlock() {}
        ...
        bool get_register(String iParam, Register &o)
        {
            for (auto i = _registers.begin(); i < _registers.end(); i++)
            {
                if (i->_name == iParam)
    ...
    struct BlockValues
    {
        ...
        bool get_register(const String &iParam, Register &o)
        {
    ...
    public:
        Master()
        {
            std::vector<RegisterBlock> blocks = MODBUS_TYPE::getRegisterBlocks();
        ...
        RegisterBlock *get_block(const String &name)
        {
        ...
        std::vector<RegisterBlock> _blocks;
    };
